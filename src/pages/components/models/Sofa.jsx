...
export function Sofa(props) {
  const { nodes, materials } = useGLTF('../../../public/models/sofa/scene.gltf');
      ...
      <group rotation={[-Math.PI / 2, 0, 0]} scale={1.282}>
        <group rotation={[Math.PI / 2, 0, 0]} scale={0.025}>
          <group scale={0.394}>
            ...
            <mesh geometry={nodes.sofa_geo_Leather_mat_0_1.geometry} material={materials.Leather_mat} />
          </group>
          <mesh geometry={nodes.legs_geo4_wood_mat_0.geometry} material={materials.wood_mat} scale={0.394} />
        </group>
      </group>
    </group>
  );
